...
(function (wid, dcm) {
    ...
    DateSelector.prototype = {
        ...
        initBinding: function () {
            ...
            on('touchstart', 'date-selector-btn-save-' + _this.container, function (e) {
                e.preventDefault();
                e.stopPropagation();
            ...
            on('touchstart', 'date-selector-bg-' + _this.container, function (e) {
                e.preventDefault();
                e.stopPropagation();
                bg.classList.remove('date-selector-bg-up');
                container.classList.remove('date-selector-container-up');
            ...
            on('touchstart', 'date-selector-btn-cancel', function (e) {
                e.preventDefault();
                e.stopPropagation();
                bg.classList.remove('date-selector-bg-up');
                container.classList.remove('date-selector-container-up');
